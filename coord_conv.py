...
# Official CoorConv implementation from https://arxiv.org/pdf/1807.03247.pdf


class AddCoords(base.Layer):
    """Add coords to a tensor"""

    def __init__(self, x_dim, y_dim, with_r=True):
    ...
    def call(self, input_tensor):
        ...
        xx_channel = tf.cast(xx_channel, tf.float32) / tf.cast(self.x_dim - 1, tf.float32)
        yy_channel = tf.cast(yy_channel, tf.float32) / tf.cast(self.y_dim - 1, tf.float32)
